  ...
  return (
    <div className={`flex items-center justify-between px-2.5 py-1.5 sm:px-4 sm:py-3 bg-zinc-900/80 backdrop-blur-md border-zinc-800/50 ${reverse ? 'flex-row-reverse border-b' : 'border-t'}`}>
      ...
      <div className={`flex gap-1.5 sm:gap-3 ${reverse ? 'flex-row-reverse' : ''}`}>
        <div className="flex flex-col items-center justify-center bg-zinc-950/50 px-1.5 py-0.5 sm:px-3 sm:py-1.5 rounded-md sm:rounded-lg border border-zinc-800/50 min-w-[2.5rem] sm:min-w-[3.5rem]">
          <Crosshair className="w-3 h-3 sm:w-4 sm:h-4 text-red-500 mb-0.5" />
          <span className="text-[10px] sm:text-sm font-bold text-zinc-100 leading-none">{bullets}</span>
        </div>
        <div className="flex flex-col items-center justify-center bg-zinc-950/50 px-1.5 py-0.5 sm:px-3 sm:py-1.5 rounded-md sm:rounded-lg border border-zinc-800/50 min-w-[2.5rem] sm:min-w-[3.5rem]">
          <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-blue-500 mb-0.5" />
          <span className="text-[10px] sm:text-sm font-bold text-zinc-100 leading-none">{blockLeft}</span>
        </div>
      </div>
    </div>
  );
